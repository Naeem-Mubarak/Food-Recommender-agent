...
flowchart LR
    ...
    history_loader --> order_collection["order_collection<br/>gathers the food order"]
    order_collection --> check_order_completness["check_order_completness<br/>validates order details"]
    ...
    class data_receiver,check_user,order_collection,check_order_completness,select_item,order_confirmation,update_db coreNode
    class history_loader,new_user,recommendations,complete_info branchNode
```

</details>

Static PNG exports of the graph are also available in [`Graph/`](Graph/).## Architecture
